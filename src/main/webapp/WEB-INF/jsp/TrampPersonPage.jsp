...
<img src="${TrampPerson.trampPersonPic} " style="float:left;height:350px;width:250px;border:1px solid #DCDCDC;margin-left:2cm;margin-top:3cm">
...
<p style="color:green;float:left;margin-left:2cm">姓名:&nbsp&nbsp&nbsp</p> <p class="name" style="float:left;">${TrampPerson.trampPersonName}</p></div> 
<div style="width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">身高:&nbsp&nbsp&nbsp</p> <p class="high" style="float:left;">${TrampPerson.trampPersonHigh} </p></div>
<div style="width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">性别:&nbsp&nbsp&nbsp</p> <p class="sex" style="float:left;">${TrampPerson.trampPersonSex} </p></div>

<div style="width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">地点:&nbsp&nbsp&nbsp</p> <p class="place" style="float:left;">${TrampPerson.trampPersonPlace}</p></div>
<div style="blue;width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">特征描述:&nbsp&nbsp&nbsp</p> <p class="feature"style="float:left;">${TrampPerson.trampPersonFeature} </p></div>
<div style="blue;width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">其他说明:&nbsp&nbsp&nbsp</p> <p class="other"style="float:left;">${TrampPerson.other} </p></div>
<div style="width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">联系人方式:&nbsp&nbsp&nbsp</p> <p class="telephone"style="float:left;">${TrampPerson.telephonenumber} </p></div>
<div style="width:600px;height:50px">
<p style="color:green;float:left;margin-left:2cm">联系人邮箱:&nbsp&nbsp&nbsp</p> <p class="telephone"style="float:left;">${TrampPerson.email} </p></div>
  </div>
